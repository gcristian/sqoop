...
public class TestTargetDir extends ImportJobTestCase {
  ...
  public void testSeveralOutputsIAException() throws IOException {
	  ...
	  try {
		...
		fail("warehouse-dir & target-dir were set and run without problem reported");
  ...
  /** test target-dir breaks if already existing (only allowed in append mode) */
